...
from confs.hyper_params import (
    ...
    feature_item_proto_c_hyper_params,
    feature_item_proto_c_noid_hyper_params,
    feature_item_proto_c_noid_iw_hyper_params,
    feature_item_proto_alpha_hyper_params,
...
MODEL_CONFIGS = {
    ...
    # dc06 fI′ experimental arms (ml-1m only wave; design doc §6 run set)
    'feature_item_proto_c': feature_item_proto_c_hyper_params,
    'feature_item_proto_c_noid': feature_item_proto_c_noid_hyper_params,
    'feature_item_proto_c_noid_iw': feature_item_proto_c_noid_iw_hyper_params,
    'feature_item_proto_alpha': feature_item_proto_alpha_hyper_params,
