...
**Disposition:** SC.1b gate walkthrough 2026-07-11 — **approved by user in the final form above** (characterize→exhibit→remedy→delimit, threshold-free research side, delegated production math problem, human-performability condition). Amendment lands at SC.2; toy exhibit joins SC.2's re-check round; counting script committed when code is touched.
