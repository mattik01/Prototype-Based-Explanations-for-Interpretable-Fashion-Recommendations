...
|----|-------|---------------|------------|--------------------------------------------|------|--------|------|
| dc01 | Feature-composed item factors under the double-tied prototype layer | B5 LightFM × B3 SVDFeature × A1 ProtoMF | corpus | features→factors (sum of feature embeddings replaces item ID table) × prototype profile via shared geometry cos(e_f, p_k), unenforced × per-prototype contribution + exact per-feature shares of activations (grouped/determinacy-annotated) + exact linear-half attribution | — | concept amended (scrutiny SC.2) | 2026-07-12 (SC.1a/1b findings F-DC01-01..07 applied; orig. 2026-06-11) |
