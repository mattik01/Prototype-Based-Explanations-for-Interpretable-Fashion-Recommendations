...
\begin{itemize}
    \item [TBD] Intrinsic vs post-hoc explanation — Rudin stance; the nuance: post hoc concerns the \emph{naming}, not the model. \vault{2026-06-11_1220_posthoc-naming-vs-intrinsic-model-distinction, 2026-06-16_1808_intrinsic-over-posthoc-principle, 2026-06-08_1149_prototype-naming-and-similarity-routes}
...
\begin{itemize}
    ...
    \item [PLANNED] Small ablation: their effect on accuracy AND the legibility measures. \vault{2026-07-14_1152_outline-refinement-ch2-8-structural-decisions}
