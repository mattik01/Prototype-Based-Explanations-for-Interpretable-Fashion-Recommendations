...
% Date: 2026-08-20 · Granularity: full section 5.1 (fi-why)
% Outline followed: 3-paragraph compressed outline agreed 2026-08-20
% (bullets in 06_fi_protomf.tex §fi-why). Cite keys: koren2009mf,
% samuelson1948consumption added as stubs to bibliography.bib this session.
% ============================================================================
...
Chapter~\ref{ch:data}. Grounding therefore starts on the item side. The
order is forced by the data, and the user side follows once its revealed
taste can be expressed in item vocabulary (Chapter~\ref{ch:fu}).
